...
CALL TAKE_INPUT ;call the procedure TAKE_INPUT
...
MOV AX,BX ;set AX=BX
CALL TAKE_OUTPUT ;call the procedure TAKE_OUTPUT
MOV AH,4CH ;return 0
INT 21H
MAIN ENDP

;Procedure Definition: TAKE_INPUT
;this procedure will read a number TAKE_INPUTimal form
;input : none
...
JNE CHECK_REMOVE_PLUS ;jump to label CHECK_REMOVE_PLUS if
CH!=1
...
TAKE_INPUT ENDP
;Procedure Definition: TAKE_OUTPUT
